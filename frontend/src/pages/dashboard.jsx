  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center h-full text-red-500">
        <div className="p-8 text-center text-red-500">Gagal memuat data. Pastikan semua server berjalan.</div>;
      ...
      <main className="w-full mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md flex items-center space-x-4">
                ...
                <div>
                    <h2 className="text-sm font-medium text-gray-500 dark:text-gray-400">Tekanan Terakhir</h2>
                    <p className="text-2xl font-bold dark:text-white">{lastInputs.pressure} psi</p>
                </div>
            </div>
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold">{lastInputs.temp}°C</p>
            </div>
          </div>
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold">{lastInputs.thickness}</p>
            </div>
          </div>
        </div>
              ...
              <div className="overflow-x-auto mt-4">
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50 dark:bg-gray-700">
                    <tr>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">Waktu</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">Tekanan</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">Suhu</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-white uppercase tracking-wider">Ketebalan</th>
                    </tr>
                  </thead>
                  <tbody className="bg-white divide-y dark:bg-gray-700 divide-gray-200">
                    {historicalData?.map((row) => (
                      <tr key={row.id}>
                        <td className="px-6 py-4 whitespace-nowrap text-sm dark:text-white text-gray-600">{row.time}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm dark:text-white text-gray-600">{row.tekanan} psi</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm dark:text-white text-gray-600">{row.suhu}°C</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm dark:text-white text-gray-600">{row.ketebalan}</td>
                      </tr>
                    )).reverse()}
                  </tbody>
                </table>
